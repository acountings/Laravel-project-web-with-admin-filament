@php
$site_name = get_setting_value('_site_nama');
$jumbotron = get_section_data('JUMBOTRON');
$location = get_setting_value('_location');
$siteDescript = get_setting_value('_site_description');
...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @if ($facebook)    
            <a class="btn btn-outline-light btn-social mx-1" href="{{$facebook}}" target="blank"><i class="fab fa-fw fa-instagram"></i></a>
            @endif

            @if ($instagram)
            <a class="btn btn-outline-light btn-social mx-1" href="{{$instagram}}" target="blank"><i class="fab fa-fw fa-facebook-f"></i></a>    
            @endif
          </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container"><small>Copyright &copy; Your {{$site_name}} 2023</small></div>
    </div>
    <!-- Partner Modals-->
    @php
        $i=1
